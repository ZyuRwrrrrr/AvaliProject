...
public class NovaItemRenderer extends GeoItemRenderer<NovaItem> {
    ...
    @Override
    public void renderRecursively(PoseStack stack, NovaItem animatable, GeoBone bone, RenderType type, MultiBufferSource buffer, VertexConsumer bufferIn, boolean isReRender, float partialTick, int packedLightIn, int packedOverlayIn, int color) {
